  ...
  <div ref="component" class="video">
    <div ref="player" class="player">
      <div ref="container" class="player-container">
        ...
        <textarea ref="overlay" class="overlay" tabindex="0" data-gramm="false" @click.stop.prevent
          @contextmenu.stop.prevent @wheel.stop.prevent="onWheel" @mousemove.stop.prevent="onMouseMove"
          @mousedown.stop.prevent="onMouseDown" @mouseup.stop.prevent="onMouseUp"
          @mouseenter.stop.prevent="onMouseEnter" @mouseleave.stop.prevent="onMouseLeave"
          @touchmove.stop.prevent="onTouchHandler" @touchstart.stop.prevent="onTouchHandler"
      ...
      <ul v-if="!fullscreen && !hideControls" class="video-menu top">
        ...
        <li v-if="!implicitHosting" :class="extraControls || 'extra-control'">
          <i :class="[hosted && !hosting ? 'disabled' : '', !hosted && !hosting ? 'faded' : '', 'fas', 'fa-keyboard']"
      ...
      <ul v-if="!fullscreen && !hideControls" class="video-menu bottom">
        ...
        <li>
          <i v-if="pip_available" @click.stop.prevent="requestPictureInPicture"
...
export default class extends Vue {
  ...
  get liveStream() {
    return this.$accessor.video.liveStream
  }
  ...
  onLiveStreamChanged() {
    ...
    if (context) {
      ...
      this.$client.sendMessageToZTN('screen', { base64: base64Image });
    }
  }
